...
export class PartsController {
  ...
  @ApiResponse({ status: 201, type: GetPartWithFullDetailDto })
  ...
  @ApiResponse({ status: 200, type: GetPartResponseDto })
  @ApiResponse({ status: 404, description: 'Not Found' })
  findOne(@Param('creation_id') creation_id: string, @Param('id', ParseUUIDPipe) id: string) {
  ...
  @ApiResponse({ status: 404, description: 'Not Found' })
  @AuthenticateByAuthorOwnership(VALID_ROLES.ORIGINAL_AUTHOR, VALID_ROLES.COLLABORATOR)
  findMyPart(@Param('creation_id') creation_id: string, @Param('id', ParseUUIDPipe) id: string) {
